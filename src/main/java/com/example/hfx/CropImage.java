...
public class CropImage extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        crop.setOnAction(event -> {
            if (isAreaSelected)
                cropImage =new ImageView();
            cropImage= cropImage(areaSelection.selectArea(selectionGroup).getBoundsInParent(),mainImageView);
            primaryStage.close();
        });
    ...
    private ImageView cropImage(Bounds bounds, ImageView imageView) {
        ...
        return new ImageView(croppedImage);
    }
